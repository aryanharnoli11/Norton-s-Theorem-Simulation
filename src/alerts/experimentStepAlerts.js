export const EXPERIMENT_ALERTS = {
  ...
  powerOn: {
    description: 'The voltage source is now feeding the verified circuit.',
    icon: '⚡',
    stepNumber: 4,
    target: '#power-supply',
    title: 'Voltage Source Turned ON',
    type: 'success',
  },
  currentSourceOn: {
  title: 'Current Source Turned ON',
  description: 'The current source is now feeding the verified circuit.',
  icon: '⚡',
  stepNumber: 4,
